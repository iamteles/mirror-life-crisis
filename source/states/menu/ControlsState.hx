...
class ControlsState extends MusicBeatState
{
	...
	var grpMain:FlxTypedGroup<AlphabetMenu>;
	...
	var grpLabel:FlxTypedGroup<AlphabetMenu>;
	...
	override function create()
	{
		...
		grpLabel = new FlxTypedGroup<AlphabetMenu>();
	...
	public function reloadMenu(curMenu:String = "main")
	{
		...
		switch(curMenu.toLowerCase())
		{
			case "main":
				var daStuff:Array<String> = ["Keyboard", "Gamepad"];
				for(i in 0...daStuff.length)
				{
					var item = new AlphabetMenu(0, 0, daStuff[i], true);
			...
			default:
				...
				{
					var label = new AlphabetMenu(0, 0, controlList[i], true);
					...
					label.x = (128 - 50) - 50;
					controlA.x = (128 + 300) - 50;
					controlB.x = (128 + 600 + 128) - 130;
