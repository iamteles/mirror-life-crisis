...
class Intro extends MusicBeatState
{
    ...
    var lines:Array<String> = ['This is Minami.', "She's quite the unhappy individual, you see.", "Everyday, she goes to work and returns, no time for entertainment or fun.", "I think its time for a change."];
    var curLine:Int;
